...
! function (e, n, t) {
    ...
    function h(e, n, s, o) {
        ...
        for (var d, p, c, h, g, v = ["modernizr", "tspan", "samp"]; !P.style && v.length;) d = !0, P.modElem = i(v.shift()), P.style = P.modElem.style;
        for (c = e.length, p = 0; c > p; p++)
            if (h = e[p], g = P.style[h], a(h, "-") && (h = l(h)), P.style[h] !== t) {
    ...
    Modernizr.addTest("preserve3d", function () {
        var e = i("a"),
            n = i("a");
        e.style.cssText = "display: block; transform-style: preserve-3d; transform-origin: right; transform: rotateY(40deg);", n.style.cssText = "display: block; width: 9px; height: 1px; background: #000; transform-origin: right; transform: rotateY(40deg);", e.appendChild(n), x.appendChild(e);
    ...
    Modernizr._q.unshift(function () {
        delete P.style
    }), w.testAllProps = g, w.testAllProps = v, Modernizr.addTest("csstransitions", v("transition", "all", !0)), s(), o(y), delete w.addTest, delete w.addAsyncTest;
